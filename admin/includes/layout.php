...
<title><?php echo htmlspecialchars($title); ?> — OMG Graphics Admin</title>
...
<script>(function(){var t=localStorage.getItem('omg_graphics_admin_theme')||'light';document.documentElement.setAttribute('data-theme',t);})();</script>
</head>
<body>
...
function layout_sidebar(string $active = 'dashboard'): void {
  ...
  <aside class="admin-sidebar" id="admin-sidebar">
    <div class="sidebar-brand">
      <div class="sidebar-logo">
        <svg width="28" height="28" viewBox="0 0 36 36" fill="none">
          ...
          <text x="18" y="25" text-anchor="middle" font-family="Inter,sans-serif" font-weight="900" font-size="13" fill="white">OMG</text>
        </svg>
        <div>
          <div class="sidebar-brand-name">Graphics</div>
    ...
    <div class="sidebar-bottom">
      ...
      <button class="nav-link theme-btn" id="theme-toggle-btn" onclick="(function(){var h=document.documentElement;var n=h.getAttribute('data-theme')==='dark'?'light':'dark';h.setAttribute('data-theme',n);localStorage.setItem('omg_graphics_admin_theme',n);document.querySelector('.theme-label').textContent=n==='dark'?'Light Mode':'Dark Mode';})()">
  ...
  <script>
  (function(){
    var t=localStorage.getItem('omg_graphics_admin_theme')||'light';
